...
const CurrentPlan = ({lengthOfPlan,planDate}) => {
    const [isDone, setIsDone] = useState(false)
    function handleDone(){
        setIsDone(true);

    }
  return (<div className="  mb-0 md:mb-4 lg:mb-4 flex py-4 px-8  bg-yellow-800  border-yellow-500 border-2 rounded-2xl  flex-col justify-center text-rigth ">
    ...
    ستنتهي من ختمة القرآن في {lengthOfPlan ? getDateAfterDays(lengthOfPlan,new Date()) : null}
    </h1>
