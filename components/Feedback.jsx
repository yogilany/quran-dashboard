<section className="text-neutral-400 bg-neutral-800 body-font text-right">
<div className="container px-5 py-24 mx-auto">
  ...
  <div className="xl:w-1/2 lg:w-3/4 w-full mx-auto sm:text-left md:text-center">
    <svg
      ...
      fill="currentColor"
      className="inline-block w-8 h-8 text-neutral-500 mb-8"
    ...
    <p className="text-neutral-500">Software Applications Developer</p>
  </div>
</div>
</section>